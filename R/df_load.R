...
#' @param skip1 The number of rows to skip at the beginning
#' of the file for the first splited dataset.
#' @param skip2 The number of rows to skip at the beginning
#' of the file for the second splited dataframe.
#' @param n_max1 The maximum number of rows to read for the
#' first splited dataframe.
#' @param n_max2 The maximum number of rows to read for the
#' second splited dataframe.
#' @param error_line The row index containing errors that
#' need to be corrected.
#' @param error_record A vector of the column indices containing
#' errors that need to be corrected.
#' @param correct_bef_error_record The number of correctly formatted
